...
__all__ = ['Bottleneck_reswgt_both_act1','DPN_reswgt_both_act1','DPN26_reswgt_both_act1','DPN92_reswgt_both_act1','DPN_X1_reswgt_both_act1']
...
class DPN_reswgt_both_act1(nn.Module):
    def __init__(self, cfg, residual_weight=1.5, activation=F.relu):
        super(DPN_reswgt_both_act1, self).__init__()
    ...
    def _make_layer(self, in_planes, out_planes, num_blocks, dense_depth, stride):
        ...
        for i,stride in enumerate(strides):
            layers.append(Bottleneck_reswgt_both_act1(self.last_planes, in_planes, out_planes, dense_depth, stride, i==0, self.residual_weight))
...
def DPN26_reswgt_both_act1(residual_weight=1.5,activation=F.relu):
    cfg = {
    ...
    return DPN_reswgt_both_act1(cfg)

def DPN92_reswgt_both_act1(residual_weight=1.5,activation=F.relu):
    cfg = {
        'in_planes': (96,192,384,768),
        'out_planes': (256,512,1024,2048),
        'num_blocks': (3,4,20,3),
...
def DPN_X1_reswgt_both_act1(residual_weight=1.5,activation=F.relu):
    cfg = {
